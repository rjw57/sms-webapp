...
class Snackbar extends React.Component {
  ...
  componentDidMount() {
    ...
    globalState.showMessage = this.showMessage;
    globalState.component = this;
  }
  ...
  componentWillUnmount() {
    ...
    if(globalState.component === this) { globalState = { }; }
  }
...
export const showMessage = message => {
  ...
  if(!globalState || !globalState.showMessage) {
    // tslint:disable-next-line:no-console
    console.error('globalState.showMessage is undefined');
    return;
  }

  globalState.showMessage(message);
}
